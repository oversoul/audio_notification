...
class AudioNotificationPlaylist {
  List<Map<String, dynamic>> songs = [];
  Map<String, dynamic> metadata;

  AudioNotificationPlaylist({this.songs, this.metadata});

  factory AudioNotificationPlaylist.fromJson(Map data) {
    return AudioNotificationPlaylist(
...
class AudioNotification {
  ...
  static AudioNotificationPlaylist playlist;
  static int index;
  ...
  static init() async {
    ...
    if (data != null) {
      ...
      playlist = AudioNotificationPlaylist.fromJson(data);
    }
  ...
  static setPlaylist(AudioNotificationPlaylist p) async {
    if (AudioNotification.playlist != p) {
      AudioNotification.playlist = p;
    ...
    _listeners.forEach((event, callback) {
      if (name == event) {
        if (name != 'position' && name != 'duration') {
          print('AudioNotification: Calling listeners for "$name"\n');
        }
